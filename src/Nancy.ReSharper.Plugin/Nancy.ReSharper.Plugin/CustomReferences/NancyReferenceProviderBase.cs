...
{
    public abstract class NancyReferenceProviderBase<TLiteral, TExpression, TMethod> : IReferenceFactory
        ...
        where TMethod : class, ITypeOwnerDeclaration, ITypeMemberDeclaration
    {
        ...
        protected NancyReferenceProviderBase([NotNull] NancyIndexer indexer, [NotNull] Version version)
        {
            myIndexer = indexer;
            myVersion = version;
        }
