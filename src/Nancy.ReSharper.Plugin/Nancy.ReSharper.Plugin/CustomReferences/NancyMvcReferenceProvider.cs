...
{
    public class NancyReferenceProvider : NancyReferenceProviderBase<ICSharpLiteralExpression, ICSharpArgumentsOwner, IMethodDeclaration>
    {
        public NancyReferenceProvider([NotNull] NancyIndexer indexer, [NotNull] Version version)
